<main class="main">
            <div class="page-header page-header-bg" style="background-image: url('<?php echo base_url().'v2/assets/images/page-header-bg.jpg'?>');">
                <div class="container">
                    ...
                    <div class="testimonials-carousel owl-carousel owl-theme">
                        <div class="testimonial">
                            <div class="testimonial-owner">
                                <figure>
                                    <img src="<?php echo base_url('v2/assets/images/clients/client1.png')?>" alt="client">
                                </figure>
                        ...
                        <div class="testimonial">
                            <div class="testimonial-owner">
                                <figure>
                                    <img src="<?php echo base_url('v2/assets/images/clients/client2.png')?>" alt="client">
                                </figure>
